...
import org.asciidoctor.internal.RubyAsciidoctorJ;
...
public class Asciidoctor {
    ...
    public static class Factory {
        ...
        public static Asciidoctor create() {
            Asciidoctor asciidoctor = new Asciidoctor();
            asciidoctor.asciidoctorJ = RubyAsciidoctorJ.create();
            return asciidoctor;
        }

        /**
         * Creates a new instance of Asciidoctor and sets GEM_PATH environment variable to provided gemPath. This method
         * is mostly used in OSGi environments.
         * 
         * @param gemPath
        ...
        public static Asciidoctor create(String gemPath) {
            Asciidoctor asciidoctor = new Asciidoctor();
            asciidoctor.asciidoctorJ = RubyAsciidoctorJ.create(gemPath);
            return asciidoctor;
        }
        ...
        public static Asciidoctor create(List<String> loadPaths) {
            Asciidoctor asciidoctor = new Asciidoctor();
            asciidoctor.asciidoctorJ = RubyAsciidoctorJ.create(loadPaths);
            return asciidoctor;
        }

        /**
         * Creates a new instance of Asciidoctor and sets a specific classloader for the JRuby runtime to use. This
         * method is mostly used in environments where different threads may have different classloaders, like build
         * tools sbt or ANT.
         *
         * @param classloader
         * @return Asciidoctor instance which uses JRuby to wraps Asciidoctor Ruby calls.
        ...
        public static Asciidoctor create(ClassLoader classloader) {
            Asciidoctor asciidoctor = new Asciidoctor();
            asciidoctor.asciidoctorJ = RubyAsciidoctorJ.create(classloader);
            return asciidoctor;
        }
