...
public class WhenStructuredDocumentIsRequired {
    ...
    public void empty_parent_title_makes_subsection_be_null_when_is_parsed() {
        ...
        StructuredDocument structuredDocument = asciidoctor.readDocumentStructure(s, new java.util.HashMap());
    ...
    public void structural_content_should_be_retrieved_from_file() {
        ...
        StructuredDocument document = asciidoctor.readDocumentStructure(new File(
                "target/test-classes/documentblocks.asciidoc"), parameters);
    ...
    public void some_real_content() {
        StructuredDocument document = asciidoctor.readDocumentStructure(new File(
                "target/test-classes/contentstructure.asciidoc"), new HashMap<String, Object>());
    ...
    public void title_should_be_retrieved_from_simple_string() {
        ...
        StructuredDocument document = asciidoctor.readDocumentStructure("= Sample RubyDocument",
    ...
    public void one_part_should_be_retrieved_from_simple_string() {
        ...
        StructuredDocument document = asciidoctor.readDocumentStructure("Simple single paragraph",
                new HashMap<String, Object>());
    ...
    public void no_parts_should_be_retrieved_from_empty_string() {
        ...
        StructuredDocument document = asciidoctor.readDocumentStructure("", new HashMap<String, Object>());
