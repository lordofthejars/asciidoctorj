...
public class ArrowsAndBoxesIncludesPostProcessor extends Postprocessor {
    ...
    public String process(Document doc, String output) {
        ...
        org.jsoup.nodes.Document parseDocument = Jsoup.parse(output);
        Element head = parseDocument.getElementsByTag("head").first();
    ...
    @Override
    public String process(org.asciidoctor.ruby.ast.RubyDocument rubyDocument, String output) {
        return null;
    }
}
