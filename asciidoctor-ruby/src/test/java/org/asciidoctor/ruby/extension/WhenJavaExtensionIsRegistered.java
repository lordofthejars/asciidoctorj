...
public class WhenJavaExtensionIsRegistered {
    ...
    class RubyIncludeSource extends IncludeProcessor {
        ...
        @Override
        public void process(Document doc, PreprocessorReader reader, String target,
    ...
    public void an_inner_class_should_be_registered() {
        ...
        JavaExtensionRegistry javaExtensionRegistry = this.asciidoctor.createExtensionRegistry(JavaExtensionRegistry.class);

        javaExtensionRegistry.includeProcessor(new RubyIncludeSource(new HashMap<String, Object>()));

        String content = asciidoctor.convertFile(new File("target/test-classes/sample-with-uri-include.ad"), options()
                .toFile(false).get());
    ...
    public void a_preprocessor_as_string_should_be_executed_before_document_is_rendered() {
        ...
        javaExtensionRegistry.preprocessor("org.asciidoctor.ruby.extension.ChangeAttributeValuePreprocessor");
    ...
    public void a_postprocessor_as_string_should_be_executed_after_document_is_rendered() throws IOException {
        ...
        javaExtensionRegistry.postprocessor("org.asciidoctor.ruby.extension.CustomFooterPostProcessor");

        Options options = options().inPlace(false).toFile(new File(testFolder.getRoot(), "rendersample.html"))
                .safe(SafeMode.UNSAFE).get();

        asciidoctor.convertFile(new File("target/test-classes/rendersample.asciidoc"), options);
    ...
    public void a_include_processor_as_string_should_be_executed_when_include_macro_is_found() {
        ...
        javaExtensionRegistry.includeProcessor("org.asciidoctor.ruby.extension.UriIncludeProcessor");
    ...
    public void a_treeprocessor_should_be_executed_in_document() {
        ...
        String content = asciidoctor.convertFile(new File("target/test-classes/sample-with-terminal-command.ad"),
                options().toFile(false).get());
    ...
    public void a_treeprocessor_as_string_should_be_executed_in_document() {
        ...
        javaExtensionRegistry.treeprocessor("org.asciidoctor.ruby.extension.TerminalCommandTreeprocessor");
    ...
    public void extensions_should_be_correctly_added_using_extension_registry() throws IOException {
        ...
        asciidoctor.convertFile(new File("target/test-classes/arrows-and-boxes-example.ad"), options);
    ...
    public void a_block_macro_extension_should_be_executed_when_macro_is_detected() {
        ...
        String content = asciidoctor.convertFile(new File("target/test-classes/sample-with-gist-macro.ad"), options()
                .toFile(false).get());
    ...
    public void a_block_macro_as_string_extension_should_be_executed_when_macro_is_detected() {
        ...
        javaExtensionRegistry.blockMacro("gist", "org.asciidoctor.ruby.extension.GistMacro");
    ...
    public void an_inline_macro_as_string_extension_should_be_executed_when_an_inline_macro_is_detected() {
        ...
        javaExtensionRegistry.inlineMacro("man", "org.asciidoctor.ruby.extension.ManpageMacro");

        String content = asciidoctor.convertFile(new File("target/test-classes/sample-with-man-link.ad"), options()
                .toFile(false).get());
    ...
    public void a_block_processor_as_string_should_be_executed_when_registered_block_is_found_in_document()
        ...
        javaExtensionRegistry.block("yell", "org.asciidoctor.ruby.extension.YellStaticBlock");
        String content = asciidoctor.convertFile(new File("target/test-classes/sample-with-yell-block.ad"), options()
                .toFile(false).get());
        org.jsoup.nodes.Document doc = Jsoup.parse(content, "UTF-8");
