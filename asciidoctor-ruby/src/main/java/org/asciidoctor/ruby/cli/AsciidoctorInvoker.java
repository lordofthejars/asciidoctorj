...
public class AsciidoctorInvoker {
    ...
    private Asciidoctor buildAsciidoctorJInstance(AsciidoctorCliOptions asciidoctorCliOptions) {
        ...
        if(asciidoctorCliOptions.isLoadPaths()) {
         asciidoctor = new Asciidoctor(RubyAsciidoctorJ.Factory.create(asciidoctorCliOptions.getLoadPaths()));
        } else {
            asciidoctor = new Asciidoctor(RubyAsciidoctorJ.Factory.create());
        }
        return asciidoctor;
    }
